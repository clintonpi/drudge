...
const createTables = `
  ...
  CREATE TABLE todos(id UUID PRIMARY KEY, user_id UUID REFERENCES users(id) ON DELETE CASCADE, todo TEXT NOT NULL, creation_date TIMESTAMPTZ NOT NULL DEFAULT NOW());
`;
